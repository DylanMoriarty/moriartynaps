...
twit-img: "https://moriartynaps.org/assets/graphics/posts/19-albums/twi-img.jpg"
...
soc-type: "article"
soc-img: "https://moriartynaps.org/assets/graphics/posts/19-albums/soc-img.jpg"
...
Joy Divison's Unknown Pleasures simple and beautiful cover has led to great cartographic pastiches.

From <a href="https://www.reddit.com/r/dataisbeautiful/comments/lgrtbq/oc_germanys_population_density_as_a_joy_plot_map/" target="_blank">kudos blooms on Reddit</a>, to being written up by everyone from <a href="https://cartographicperspectives.org/index.php/journal/article/view/1536/1726" target="_blank">Cartographic Persectives</a> to <a href="https://www.vice.com/en/article/d748kz/digital-maps-inspired-by-joy-divisions-unknown-pleasures-album-art" target="_blank">Vice</a>, and lining the storefronts of <a href="https://www.etsy.com/listing/614935069/topo-lines-world-map-print-physical?ga_order=most_relevant&ga_search_type=all&ga_view_type=gallery&ga_search_query=topo-lines+joy&ref=sr_gallery-1-2&organic_search_click=1&pro=1&frs=1&col=1" target="_blank">kitschy Etsy stores</a>, truly, it's a well trodden, well loved style.

Odd, then, that we stopped there. 

Surely in the vast ocean of famous album covers, there are designs we can take inspiration from..<span class="tinytext">...from which we launch _our own_ kitschy Etsy stores!?</span>
...
We gotta start with the champ of famous covers, _Dark Side of the Moon_.

Where 'Unknown Pleasure' easily translates to rising and falling elevation data, here there's a white line entering a prism and exiting as a brilliant rainbow to work with. Clearly, a great analouge for the lines that make up roads. & road maps are <a href="https://www.etsy.com/search?q=city%20road%20map" target="_blank">hot hot hot</a>!
...
<div class="mbmap-btns">
  ...
  <div class="mbmap-btn darksyde-lock">Lock Map</div>
</div>
...
In ’78 the Talking Heads released _More Songs About Buildings and Food_, featuring a cover of the bandmates diced up into chunks by Polaroids and reassembled into people shapes.

There are no satellites (that I know of) with Polaroid cameras aboard. We'll have to settle for multispectral instruments instead.
...
Maybe the quick design that graced Elvis's debut album, and later achieved fame gracing _London Calling_.
...
Let's open this up to cities world wide as well why not,
...
<div class="mbmap-btns">
  ...
  <div class="mbmap-btn calling-lock">Lock Map</div>
</div>
...
It seems, perhaps, Unknown Pleasures enjoys success thanks less to the _aethestic_, and more the utility of it. There are certainly more use cases for stacked lines of varying values in map making than, say, mountain tops colored like a space rocker's flamboyet mullet.
...
<div class="notes">
  ...
  <p>Unused ideas: The Beatles – where all features are white but are styled to be have faint shadows like they were embossed. Queen II - with four mountains all named 'Queen Mountain' arranged under a northern spotlight. DAMN., but all the DAMS in a country... so, so much to do.</p>
