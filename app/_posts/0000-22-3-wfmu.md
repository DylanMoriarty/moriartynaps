...
Radio, to me, had always been a dissapointment. Driving across country the options are "_Today's Hot 100_", "_Yesterday's Hot 100_", or "_Christian Pop_". If you’re lucky, ya might find an enthusiastic preacher. But I can’t recall a time growing up when something came on that was exciting.
...
_All the cd's in this post are shows on the station I'd reccomend! If something perks your ears, dive with abandon down that rabbit hole._
...
A perfect storm of things have led to them surviving into 2022. Being a stone’s throw away from a metropolis and staying savvy as technology has changed have helped. But WFMU's culture and stubborn adherence to their principals have contributed the most.
...
<section class="cd-container">
  <ol class="cd-case">
    {% include blog-bits/wfmu/cd.html 
      ...
      host="Suzy Hotrod"
      img="derby"
      descrip='"Six-pack abs for the seedy underbelly with Gotham Roller Derby\'s own Suzy Hotrod. Rock and roll, punk, and things with a good beat that make you dance, sweat, and/or punch something. Plus hard hits of girl groups, country heroes, and soul."'
      pos="l"
...
After the marathons end, those same folks return to help pack up swag promised to donors and ship it out. There are thousands of packages to pack and truck off to the post office next door, a monotomous, and easy-to-chat-over task.
...
The music is as eccelectic in genre as the rest of the station, tho it leans more Pop and less throat singing or bagpipes. Not _no_ throat singing or bagpipes, just _less_.

Clay Pigeon, the host, is first and foremost a genius at a soundboard. The sound effect drops are frequent and perfectly timed. But he's also got an undeniable charisma, which shines through in interviews and games with listeners (glisteners as Clay refers to em'), and daily skits he performs.

{% include postimg.html imgsrc="posts/20-wfmu/clay-page.png" class="inline-img" %}

Given the show has such a tight production to it, yet more volunteers are called to help keep the machine oiled. Writing news items for Clay to recite, 

I was one of those "associate producers" for a good two years!
...
The work itself was pretty light. Making sure the show stays on track, printing off the news, and screening calls. Which meant for the most part I could sit amongst the station's record library, digging through and ripping cd's. Drawing portraits from the covers. To my credit, I only fell asleep a few times on this shift. 

{% include postimg.html imgsrc="posts/20-wfmu/wake-list.jpg" full="true" class="black-border" %}

If you haven't already clicked away to one of the many suggested shows, I'll implore once more ya try one out. Maybe before you go to Spotify radio or Pandora, instead maybe check out the <a href="https://www.wfmu.org/table" target="_blank">showlist here</a>, and see if you can get your Soul fix from <a href="https://www.wfmu.org/playlists/SV" target="_blank">Mr. Fine Wine</a> instead of a cold AI.
